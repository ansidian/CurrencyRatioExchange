...
namespace CurrencyRatioExchange.Utils
{
    internal static class Mouse
    {
        ...
        /// <summary>
        /// Set the cursor position once, without the polling/retry loop of <see cref="MoveMouse"/>.
        /// Used to restore the cursor after automation so we never fight the user for control.
        /// </summary>
